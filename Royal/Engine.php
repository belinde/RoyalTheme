...
class Engine
{
    ...
    public function actionAfterSetupTheme()
    {
        ...
        add_image_size('royaltile', 431, 285, true);
     ...
     * @param $corrente
     */
    private function populator(&$query, $params, $foresto, $corrente)
    {
        $dict = [
            'categoria' => [
                'vendite' => 3,
...
//            'san colombano di certenoli' => 3,
    ...
    private function redirects()
    {
        if (false !== strpos($_SERVER['REQUEST_URI'], 'immobili_elenco.php')) {
            ...
            $this->populator($query, $params, 'categoria', 'rs_con');
            $this->populator($query, $params, 'tipologia', 'rs_tip');
            $this->populator($query, $params, 'zona', 'rs_com');
...
//        248=>'a1'
        ...
        if (false !== strpos($_SERVER['REQUEST_URI'], 'immagine_big.php')) {
